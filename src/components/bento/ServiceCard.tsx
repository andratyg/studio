...
export default function ServiceCard() {
  const services = [
    "Sistem Web Kustom",
    "Optimasi Database",
    "Perbaikan Bug (Fixing)"
  ];

  return (
    <div className="bento-card p-6 flex flex-col justify-between h-full">
      <div className="space-y-4">
        <h3 className="text-sm font-code text-muted-foreground uppercase tracking-widest">Layanan</h3>
      ...
      <div className="mt-6 pt-4 border-t border-white/5">
        <div className="flex items-center gap-2 text-[10px] font-bold tracking-wider">
          ...
          <span className="text-green-500 uppercase">Tersedia untuk Komisi</span>
        </div>
        <p className="text-[10px] font-code text-muted-foreground mt-1">Menerima USD / IDR</p>
      </div>
    </div>
  );
}
